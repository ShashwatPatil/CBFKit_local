...
drift_dynamics = "[x[1], -x[0] + epsilon * (1 - x[0]**2) * x[1]]"    # X1 , -Xo + E * (1 - Xo^2) * X1
control_matrix = "[[0], [1]]"
...
nominal_control_law = "x[0] * (1 - k_p) - epsilon * (1 - x[0]**2) * x[1]"    #  Xo * (1 - Kp) - E * (1 - Xo^2)*X1
